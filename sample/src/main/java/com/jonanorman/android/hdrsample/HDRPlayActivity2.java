...
//
//public class HDRPlayActivity2 extends AppCompatActivity {
//
...
//    HDRPlayActivity2.CodecCallBack decodeCallBack;
...
//                HDRPlayActivity2.this.surface = holder.getSurface();
...
//
//                int aa =0;
//                if (isYuvTargetExtensionSupported()){
//                  aa = 1;
//                }
...
//                rgbTextureLayer = new GLTextureLayer(true);
//                rgbTextureLayer.setVertexShaderCode(AssetsUtils.getString(HDRPlayActivity2.this, "ext_yuv_hdr.vsh"));
//                rgbTextureLayer.setFragmentShaderCode(AssetsUtils.getString(HDRPlayActivity2.this, "ext_yuv_hdr.fsh"));
//
...
//            }
//            decodeCallBack = new HDRPlayActivity2.CodecCallBack();
