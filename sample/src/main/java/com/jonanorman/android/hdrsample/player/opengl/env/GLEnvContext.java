...
public interface GLEnvContext {
    ...
    class Builder {
        ...
        public GLEnvContext build() {
            GLEnvContextAttrib envContextAttrib = new EnvContextAttribImpl();
            envContextAttrib.setClientVersion(version);
            GLEnvContext envContext = new EnvContextImpl(envDisplay, envConfig, envContextAttrib, shareContext);
            return envContext;
        }
    }
