...
object MetaDataParams : GLShaderCode() {
    const val MIN_DISPLAY_LUMINANCE ="MIN_DISPLAY_LUMINANCE"// 屏幕亮度范围
    const val MAX_DISPLAY_LUMINANCE ="MAX_DISPLAY_LUMINANCE"// 屏幕亮度范围
    ...
    const val COLOR_SPACE ="COLOR_SPACE"// 最大平均亮度
    const val COLOR_SPACE_BT2020_PQ ="COLOR_SPACE_BT2020_PQ"// 最大平均亮度
    const val COLOR_SPACE_BT2020_HLG ="COLOR_SPACE_BT2020_HLG"// 最大平均亮度
